...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/server/registration.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/server/registration.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/server/</a> &#187; registration.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (config.types) {
...
&nbsp;
exports.init = init;
exports.handle = handleRegistration;</pre></td></tr>
</table></pre>
