...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/server/inMemoryDeviceRegistry.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/server/inMemoryDeviceRegistry.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/server/</a> &#187; inMemoryDeviceRegistry.js</div>
</div>
<div class="body">
...
function getObject(id, callback) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (registry[id]) {
        callback(null, _.clone(registry[id]));
    } else {
<span class="cstat-no" title="statement not covered" >        callback(new errors.DeviceNotFound(id));</span>
    }
}
&nbsp;
/**
...
&nbsp;
    for(var key in registry) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (registry.hasOwnProperty(key)) {
