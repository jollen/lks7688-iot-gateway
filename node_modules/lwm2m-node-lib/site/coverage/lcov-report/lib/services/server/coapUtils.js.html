...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/server/coapUtils.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/server/coapUtils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/server/</a> &#187; coapUtils.js</div>
</div>
<div class="body">
...
&nbsp;
    for (var i = 0; i &lt; res.options.length; i++) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (res.options[i].name === 'Observe') {
            observeFlag = true;
        }
    }
    return observeFlag;
...
function generateProcessResponse(objectType, objectId, resourceId, code) {
    return function processResponse(res, callback) {
        ...
        } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (res.code === '4.04') {
            callback(new errors.ResourceNotFound(objectId, objectType, resourceId));
        } else {
<span class="cstat-no" title="statement not covered" >            callback(new errors.ClientError(res.code));</span>
        }
    };
}
&nbsp;
exports.generateProcessResponse = generateProcessResponse;
exports.sendRequest = sendRequest;</pre></td></tr>
</table></pre>
