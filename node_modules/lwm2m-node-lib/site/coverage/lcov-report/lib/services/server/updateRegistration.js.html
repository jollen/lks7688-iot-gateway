...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/server/updateRegistration.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/server/updateRegistration.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/server/</a> &#187; updateRegistration.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            logger.debug(context, 'Registration request ended up in error [%s] with code [%s]', error.name, error.code);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            res.code = error.code;</span>
<span class="cstat-no" title="statement not covered" >            res.end(error.message);</span>
        } else {
...
&nbsp;
    async.series([
        ...
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (error) {
<span class="cstat-no" title="statement not covered" >            endUpdate(req, res)(error);</span>
        } else {
            async.waterfall([
...
exports.handle = handleUpdateRegistration;</pre></td></tr>
</table></pre>
