...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/coapRouter.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/coapRouter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/services/</a> &#187; coapRouter.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            logger.error(context, 'Couldn\'t start COAP server: %s', error);</span>
        } else {
