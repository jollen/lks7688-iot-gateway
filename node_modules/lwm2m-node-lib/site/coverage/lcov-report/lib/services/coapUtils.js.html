...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/coapUtils.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/coapUtils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/services/</a> &#187; coapUtils.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!req.urlObj) {
<span class="cstat-no" title="statement not covered" >        req.urlObj = require('url').parse(req.url);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (req.urlObj.query) {
        logger.debug(context, 'Processing query [%s]', req.urlObj.query);
&nbsp;
        queryParams = req.urlObj.query.split('&amp;');
    } else {
<span class="cstat-no" title="statement not covered" >        queryParams = {};</span>
    }
&nbsp;
    if (callback) {
...
&nbsp;
        for (var i in queryParams) {
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (queryParams.hasOwnProperty(i)) {
...
exports.checkMandatoryQueryParams = checkMandatoryQueryParams;</pre></td></tr>
</table></pre>
